            ...
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="card-title">Edit Hak Akses <i>({{$akses->nama_akses}})</i></h3>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('Akses.update', $akses->id)}}">
                            @csrf
                            @method('PUT')

                            <div class="form-group">
                                <label for="kode_cabang">Nama Akses</label>
                                <input type="text" class="form-control" id="kode_cabang" name="nama_akses" placeholder="Input Nama Pengguna" value="{{$akses->nama_akses}}">
                            </div>
                            <div class="form-group">

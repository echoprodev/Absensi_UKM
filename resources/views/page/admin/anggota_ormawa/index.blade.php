            ...
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="card-title">Data Anggota Organisasi Mahasiswa</h3>
                        <a href="{{ route('AnggotaOrmawa.create')}}" class="btn btn-success btn-round btn-md ml-auto ">
                                ...
                                <tbody class=" text-center">
                                    ...
                                    @forelse ($anggota_ormawa as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->status }}</td>
                                            <td>
                                                <a href="{{ route('AnggotaOrmawa.edit', $row->id)}}" class="btn btn-warning btn-sm"><i
                                                        class="fas fa-edit"></i></a>
                                                <form action="{{ route('AnggotaOrmawa.destroy', $row->id)}}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('delete')

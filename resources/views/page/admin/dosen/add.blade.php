        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('DataDosen.store')}}">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label for="kode_cabang">NIDN/NUPN</label>
                                <input type="text" class="form-control" id="kode_cabang" name="nidn_dosen" placeholder="Input NIDN/NUPN" value="">
                            </div>
                            <div class="form-group">
                                <label for="kode_cabang">Nama Dosen</label>
                                <input type="text" class="form-control" id="kode_cabang" name="nama_dosen" placeholder="Input Nama Dosen" value="">
                            </div>
                            <div class="form-group">

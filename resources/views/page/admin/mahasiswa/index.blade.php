            ...
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <a href="{{ route('DataMahasiswa.create') }}" class="btn btn-success btn-round btn-md ml-auto ">
                                ...
                                <tbody class="text-center">
                                    ...
                                    @forelse ($mahasiswa as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('DataMahasiswa.edit', $row->id)}}" class="btn btn-warning btn-sm"><i
                                                        class="fas fa-edit"></i></a>
                                                <form action="{{ route('DataMahasiswa.destroy', $row->id)}}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('delete')

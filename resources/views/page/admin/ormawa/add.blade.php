            ...
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="card-title">Tambah Data Organisasi Mahasiswa</h3>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('Ormawa.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kode_cabang" name="nama_ormawa" placeholder="Input Nama Ormawa" value="">
                            </div>
                            <div class="form-group">

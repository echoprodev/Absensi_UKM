            ...
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="card-title">Data Organisasi Mahasiswa</h3>
                        <a href="{{ route('Ormawa.create') }}" class="btn btn-success btn-round btn-md ml-auto ">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody class=" text-center">
                                    @php
                                        $id = 1;
                                    @endphp
                                    @forelse ($ormawa as $row)
                                        <tr>
                                            <td>{{ $id++ }}</td>
                                            <td>{{ $row->nama_ormawa }}</td>
                                            <td>{{ $row->pembimbing_ormawa }}</td>
                                            <td>

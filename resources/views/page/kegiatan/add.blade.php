            ...
            <div class="col-sm-6 col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="card-title">Tambah Data Kegiatan Organisasi Mahasiswa</h3>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('Kegiatan-UKM-Musik.store')}}">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label for="kode_cabang">Kegiatan Ormawa</label>
                                <input type="text" class="form-control" id="kode_cabang" name="nama_kegiatan" placeholder="Input Nama Ormawa" value="">
                            </div>
                            <div class="form-group">
                                <label for="kode_cabang">Tanggal Kegiatan</label>
                                <input type="date" class="form-control" id="kode_cabang" name="tgl_kegiatan" placeholder="Input Nama Ormawa" value="">
                            </div>
                            <div class="form-group">
                                <label for="kode_cabang">Organisasi Mahasiswa</label>
                                <select name="ormawa" id="" class="form-control">
